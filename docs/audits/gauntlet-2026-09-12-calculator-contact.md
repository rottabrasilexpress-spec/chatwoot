...
- Commits publicados nas duas branches: `9b3021428` (correção funcional/visual + bundle) e `ce9982bd0` (tag Compose/deploy). O EasyPanel mostrou `fix(deploy): publish orange calculator bundle` com check verde.
