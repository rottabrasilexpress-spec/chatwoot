...
class Account < ApplicationRecord
  has_many :rotta_automatic_label_logs, dependent: :delete_all
  ...
  store_accessor :settings, :audio_transcriptions, :auto_resolve_label, :rotta_automatic_labels
  ...
  has_many :global_ai_threads, dependent: :destroy_async
  has_many :global_ai_action_receipts, dependent: :destroy_async
