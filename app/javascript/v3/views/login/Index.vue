  ...
  >
    <section class="max-w-5xl mx-auto">
      <img
        ...
        class="block w-auto h-12 max-w-[min(88vw,30rem)] object-contain mx-auto dark:hidden sm:h-14"
      />
      <img
        v-if="globalConfig.logoDark"
        :src="globalConfig.logoDark"
        :alt="globalConfig.installationName"
        class="hidden w-auto h-12 max-w-[min(88vw,30rem)] object-contain mx-auto dark:block sm:h-14"
      />
